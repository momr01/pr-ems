...
const PlantShiftsCard = (props) => {
  ...
  const handleDelete = () => {
    ...
    console.log(`/plants/${id}/delete-assignment/shift/${props.id}/`);
  };
    ...
    <div className="col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
      <div className="flex flex-col h-full p-5">
        ...
        <div className="grow mt-2">
          <h2 className="text-xl leading-snug font-semibold">{props.name}</h2>
          {/* </Link> */}
        </div>
        <footer className="mt-5">
          <div className="text-sm font-medium text-slate-500 mb-2">
            {/* 15:00 <span className="text-slate-400">-&gt;</span> 20:00 */}
            {props.schedule}
          </div>
...
export default PlantShiftsCard;
