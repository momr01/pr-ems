...
import { useGetLanguagesQuery } from "../../features/users/usersSlice";
...
function LangSelect() {
  ...
  return (
    <div className="relative">
      <button
        ref={trigger}
        className="btn justify-between h-auto hover:border-slate-300 text-black md:px-6 hover:text-slate-600 w-full md:w-auto text-black text-lg"
      ...
      >
        <span className="flex items-center">
          ...
          <span className="hidden md:block">{languages?.[selected]?.name}</span>
        </span>
        {/* <svg
