...
const ModalAssignEquipments = ({ openModal, setOpenModal }) => {
  const { id } = useParams();

  const [selected, setSelected] = useState(items[0].id);

  const handleAssignment = () => {
    console.log("assign ", id, selected);
  };
  ...
  return (
    <ModalBasic
      ...
      title="Equipments to Plant Assignment"
    >
      <div className="px-5 pt-4 pb-1">
        <div className="text-sm">
          <div className="mb-4">Stablish equipments to plant assignment</div>
...
export default ModalAssignEquipments;
